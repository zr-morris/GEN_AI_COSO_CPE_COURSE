    ...
    return (
      <div className="max-w-4xl mx-auto">
        <div className="text-center py-16">
          <div className="w-20 h-20 rounded-full bg-kpmg-green/10 flex items-center justify-center mx-auto mb-6">
          ...
          <button
            onClick={() => dispatch({ type: 'NAVIGATE', section: 'certificate' })}
            className="inline-flex items-center gap-2 bg-kpmg-blue hover:bg-kpmg-blue/90 text-white font-semibold px-8 py-3 rounded-xl shadow-lg shadow-kpmg-blue/25 transition-all duration-200"
          >
    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="space-y-6">
        {questions.map((question, qIndex) => (
          <div key={question.id} className="bg-white border border-kpmg-border rounded-xl p-6">
            <div className="flex items-start gap-3 mb-4">
              <span className="flex-shrink-0 w-7 h-7 rounded-full bg-kpmg-light-blue text-white text-xs font-bold flex items-center justify-center">
                {qIndex + 1}
              </span>
                ...
                {likertOptions.map((option) => {
                  ...
                  return (
                    <button
                      ...
                      className={`flex flex-col items-center px-4 py-3 rounded-lg border text-center transition-all duration-150 min-w-[90px] ${
                        isSelected
