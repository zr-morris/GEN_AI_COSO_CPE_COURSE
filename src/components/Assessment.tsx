    ...
    <div className="max-w-4xl mx-auto">
      ...
      <ol className="space-y-6 list-none p-0">
        {questions.map((question, qIndex) => {
          ...
          const questionLabelId = `a-${question.id}-label`;
                ...
                {question.options.map((option) => {
                  ...
                  return (
                    <button
                      ...
                      className={`w-full flex items-center gap-3 p-3 rounded-lg border text-left transition-all duration-150 focus:outline-none focus-visible:ring-2 focus-visible:ring-kpmg-blue focus-visible:ring-offset-2 ${styles}`}
                    >
                      <div
                        aria-hidden="true"
      ...
      <div className="border-t border-kpmg-border mt-8 pt-6 pb-8 flex justify-between items-center">
        {!isSubmitted ? (
          ...
          <>
            ...
            <button
              type="button"
              onClick={() => navigate(sectionPaths.evaluation)}
              className="inline-flex items-center gap-2 bg-kpmg-green hover:bg-kpmg-green/90 text-white font-semibold px-6 py-2.5 rounded-xl shadow-lg shadow-kpmg-green/20 transition-all duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-kpmg-green focus-visible:ring-offset-2"
            >
          ...
          <>
            ...
            <button
              ...
              className="inline-flex items-center gap-2 bg-kpmg-blue hover:bg-kpmg-blue/90 text-white font-semibold px-6 py-2.5 rounded-xl shadow-lg shadow-kpmg-blue/20 transition-all duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-kpmg-blue focus-visible:ring-offset-2"
            >
